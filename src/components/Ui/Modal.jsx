...
const Modal = ({ activeId, setShowModal }) => {
  ...
  return (
    <div className="w-full h-full fixed mt-[38px] top-0 left-0 z-10 bg-headingColor bg-opacity-40">
      <div
        className="w-11/12 md:max-w-[600px] md:w-full absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform
