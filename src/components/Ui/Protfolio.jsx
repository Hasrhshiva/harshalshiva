...
const Protfolio = () => {
  ...
  const [profolios, setprotfolios] = useState(data);
    ...
    <section id="portfolio">
      <div className="container">
        ...
        <div className="flex items-center gap-4 flex-wrap mt-12">
          {profolios?.slice(0, nextItems)?.map((protfolio, index) => (
            <div
              key={index}
            ...
            >
              ...
              <div className="w-full h-full bg-primaryColor bg-opacity-80 absolute top-0 left-0 z-[5] hidden group-hover:block">
                <div className="w-full h-full flex items-center justify-center">
                  <button
                    onClick={() => showModalHandler(protfolio.id)}
        ...
        <div className="text-center mt-6">
          {nextItems < profolios.length && data.length > 6 && (
            <button
